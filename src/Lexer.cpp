...
TokenisedInstruction Lexer::tokenize(const std::string& line) {
...
std::string Lexer::extract_partial_token(const std::vector<std::string>& tokens, int token_index, int start, int length) {
...
std::string Lexer::extract_single_token(const std::vector<std::string>& tokens, int token_index) {
...
std::string Lexer::tokens_to_operation(const std::vector<std::string>&tokens) {
    return extract_partial_token(tokens, 0, 0, 3);
}

std::string Lexer::tokens_to_condition(const std::vector<std::string>&tokens) {
    return extract_partial_token(tokens, 0, 3, 2);
}

std::string Lexer::tokens_to_arg_a(const std::vector<std::string>&tokens) {
    return extract_single_token(tokens, 1);
}

std::string Lexer::tokens_to_arg_b(const std::vector<std::string>& tokens) {
    return extract_single_token(tokens, 2);
}

std::string Lexer::tokens_to_arg_c(const std::vector<std::string>& tokens) {
    return extract_single_token(tokens, 3);
}

std::string Lexer::tokens_to_s(const std::vector<std::string>& tokens) {
